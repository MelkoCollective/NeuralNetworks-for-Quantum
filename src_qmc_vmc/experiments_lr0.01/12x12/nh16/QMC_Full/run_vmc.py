...
def run_VMC(vmc, epochs, delta, qmc_data, energy, variance, batch_size=100):
    ...
    for n in range(1, epochs+1):
        ...
        a_file = open("E_QMC_{}_{}_fulldata.dat".format(Lx,nh), "w")
...
qmc_epochs = 300 # Training iterations for qmc, if 0 only do vmc
...
if continuation == 'True':
    ...
    energy = np.loadtxt("E_QMC_{}_{}_fulldata.dat".format(Lx,nh)).tolist()
