...
path = "../../QMC_data"
#dim_path = "Dim=12_M=1000000_V=7_omega=1.0_delta=1.0" # Can change this to look at Dim = 4, 8, 12, 16
dim_path = "Dim=12_M=1000000_V=7_omeg=1.0_delta=1.0" # Can change this to look at Dim = 4, 8, 12, 16
