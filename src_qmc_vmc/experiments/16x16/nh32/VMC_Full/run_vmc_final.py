...
vmc_epochs = 8610 # Training iterations for vmc, if 0 only do qmc
...
if continuation == 'True':
    ...
    wavefunction.load_weights("VMC_Final.weights")
    energy = np.loadtxt("E_VMC_Final_{}_{}.dat".format(Lx,nh)).tolist()
