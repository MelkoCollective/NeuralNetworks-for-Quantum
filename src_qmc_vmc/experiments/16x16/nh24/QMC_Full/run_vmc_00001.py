...
qmc_epochs = 287 # Training iterations for qmc, if 0 only do vmc
...
if continuation == 'True':
    ...
    wavefunction.load_weights("qmc_00001.weights")
    energy = np.loadtxt("E_QMC_{}_{}_fulldata_00001.dat".format(Lx,nh)).tolist()
