...
skip_data = 1 # Skip elements in QMC data set
...
if continuation == 'True':
    ...
    wavefunction.load_weights("qmc_smlr.weights")
    energy = np.loadtxt("E_QMC_{}_{}_fulldata_smlr.dat".format(Lx,nh)).tolist()
